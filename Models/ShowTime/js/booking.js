document.addEventListener('DOMContentLoaded', function() {
    const schedule = {
        ...
        "2024-08-02": [
            ...
            { movie: "RDeadpool", timings: { screen1: "6:00 PM", screen2: "6:15 PM", screen3: "6:30 PM", screen4: "6:45 PM" } },
    ...
    function selectTime(slot) {
        ...
        selectedDate = document.querySelector('.date-btn.selected').dataset.date;
